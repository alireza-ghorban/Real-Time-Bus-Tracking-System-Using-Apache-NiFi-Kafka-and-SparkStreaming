...
if __name__ == "__main__":
   ...
   schema = spark.read.json('s3a://ttc-streaming-bus-status/artifacts/bus_status_schema.json').schema
 ...
 # We have to connect to the bootstrap servers, instead of kafka:9092
   ...
   checkpoint_location = "s3a://ttc-streaming-bus-status/checkpoints"
   ...
   s3_path = "s3a://ttc-streaming-bus-status/output"
